...
namespace EitechPfe.Modules.User
{
    ...
    {
        private readonly EitechPfe.Modules.User.Interfaces.IUserService _userService;

        public UserController(EitechPfe.Modules.User.Interfaces.IUserService userService)
        {
