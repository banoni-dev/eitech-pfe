...
namespace EitechPfe.Repositories
{
    public class LicenseBundleRepository : ILicenseBundleRepository
    {
        ...
        {
            using var connection = _dbConfig.GetConnection();
            string sql = "SELECT * FROM license_bundles WHERE license_order_id = @Id;";
        ...
        {
            using var connection = _dbConfig.GetConnection();
            string sql = "SELECT * FROM license_bundles;";
        ...
        {
            using var connection = _dbConfig.GetConnection();
            string sql = "DELETE FROM license_bundles WHERE license_order_id = @Id;";
